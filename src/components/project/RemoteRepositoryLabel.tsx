...
export function RemoteRepositoryLabel({
  ...
  return (
    <span
      role="link"
      tabIndex={0}
      className="text-primary focus-visible:ring-ring ml-auto flex max-w-[46%] shrink-0 cursor-pointer items-center gap-1 rounded-sm font-mono text-xs hover:underline focus-visible:ring-2 focus-visible:outline-none"
      title={remote.url}
